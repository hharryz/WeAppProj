    ...
    <div className='c_header'>
      <div className='col_container'>
        ...
        <div className='col2' onClick={ClickDelete}>
            delete{/* <img src={require('../../assets/icon/delete.png')} className='c_icon_delete' />          */}
        </div>
    ...
    {(page == '0') && (
        ...
        <div className="c_footer">
          <div className="col_container">
            ...
            <div className="cold2">
              like!{/* <img src={require('../../assets/icon/like.png')} className='c_icon_like' /> */}
            </div>
            <div className="cold2">
              {isEditing ? (
...
>>>>>>> Stashed changes
          ...
          <div className='cold2' onClick={ClickDone}>
            { (isdone == true) && 
              'done'//(<img src={require('../../assets/icon/done.png')} className='c_icon_done' />)
            }
            { (isdone == false) &&
              'undone'//(<img src={require('../../assets/icon/undone.png')} className='c_icon_done' />)
            }
          </div>
        </div>
      </div>
